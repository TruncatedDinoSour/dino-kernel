...
static void set_coffee_theme(void)
{
    ...
    DLG_COLOR(searchbox,        COLOR_WHITE, COLOR_BLACK, true);
    DLG_COLOR(searchbox_title,  COLOR_WHITE, COLOR_BLACK, true);
    DLG_COLOR(searchbox_border, COLOR_BLACK, COLOR_BLACK, true);
    ...
    DLG_COLOR(tag,              COLOR_WHITE,  COLOR_BLACK, false);
    DLG_COLOR(tag_selected,     COLOR_YELLOW, COLOR_BLUE,   true);
    DLG_COLOR(tag_key,          COLOR_YELLOW, COLOR_BLACK, false);
    DLG_COLOR(tag_key_selected, COLOR_YELLOW, COLOR_BLUE,   true);

    DLG_COLOR(check,            COLOR_YELLOW, COLOR_BLACK, false);
    DLG_COLOR(check_selected,   COLOR_YELLOW, COLOR_WHITE,   true);
